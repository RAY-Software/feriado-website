...
export const metadata: Metadata = {
  ...
  description: 'Descubrí la Hora Feliz, Martes de Vermú, Menú del Mediodía y más en Feriado Cantina. Vení a disfrutar de la mejor onda cantinera en Buenos Aires.',
};
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="mb-16 text-center md:text-left">
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto md:mx-0 text-muted-foreground">
            Vení a Feriado Cantina para la Hora Feliz, Martes de Vermú, Menú del Mediodía y más — sabores de cantina y la mejor onda en cada evento.
          </p>
        </header>
        ...
        {events.length > 0 ? (
          ...
          <div className="text-center py-24 rounded-2xl border border-graphite-black/20 shadow-sm bg-white">
            ...
            <p className="text-graphite-black/80 text-lg">Pronto más experiencias en Feriado Cantina.</p>
          </div>
        )}
      </div>
    </div>
