...
export const metadata: Metadata = {
  title: "Locations | OH México — Authentic Mexican Restaurant in Miami",
  description: "Find all our OH México locations in Miami Beach. Join us for authentic Mexican food and drinks.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "ItemList",
            name: "OH México - All Locations",
            description: "Find all OH México restaurant locations in Miami.",
            ...
            itemListElement: locations.map((location, index) => ({
              ...
              item: {
                ...
                name: location.name,
                description: `${location.name} - Authentic Mexican restaurant located in ${location.city}, ${location.state}.`,
            ...
            <div className="lg:col-span-1 lg:sticky lg:top-28 lg:h-fit lg:self-start">
              <div className="py-8">
                ...
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  Experience authentic Mexican flavors right here in Miami Beach. 
                  Find the OH México location nearest to you and join us for great food, drinks, and atmosphere.
                </p>
                
                {/* Filters */}
                <div className="mb-8">
                  <h3 className="text-lg font-semibold mb-4 text-foreground">Filter by state</h3>
                  <div className="flex flex-wrap gap-2">
                    ...
                    {/* Since currently all are in FL, we just map out the static options for visual completeness.
                        If interactive filtering is needed, we would make this a client component. */}
                    {states.map((state) => (
                      <button
                        key={state}
                        ...
                        <div className="md:col-span-1 relative h-48 md:h-auto min-h-[200px] bg-pale-chestnut/10 flex items-center justify-center">
                          {location.image ? (
                            ...
                            <div className="text-center p-4">
                              ...
                              <p className="text-xs font-medium text-primary/60 uppercase tracking-widest">OH México</p>
                            </div>
                          )}
                        </div>
