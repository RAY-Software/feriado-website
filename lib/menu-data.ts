...
export const DEFAULT_MENU_ITEM_IMAGE = '/image/AVICMEDIA-82.jpg';
...
const FOOD_CATEGORIES: MenuCategory[] = [
  { id: 'tortilla-soup', label: 'Tortilla Soup', description: 'Our iconic starter.', image: '/image/AVICMEDIA-82.jpg' },
  { id: 'guacamole', label: 'Guacamole', description: 'Fresh made guacamole two ways.', image: '/image/AVICMEDIA-82.jpg' },
  { id: 'appetizers', label: 'Appetizers', description: 'Small plates to start your meal.', image: '/image/AVICMEDIA-82.jpg' },
  { id: 'salads', label: 'Salads', description: 'Fresh salads with Mexican flair.', image: '/image/AVICMEDIA-82.jpg' },
  ...
  { id: 'from-the-border', label: 'From the Border', description: 'Crowd favorites and comfort food.', image: '/image/AVICMEDIA-82.jpg' },
  { id: 'salsas', label: 'Homemade Salsas', description: 'Four house-made salsas.', image: '/image/AVICMEDIA-82.jpg' },
  { id: 'sides', label: 'Sides', description: 'Classic sides — $7 each.', image: '/image/AVICMEDIA-82.jpg' },
  { id: 'desserts', label: 'Desserts & Cordials', description: 'Sweet endings and after-dinner drinks.', image: '/image/AVICMEDIA-82.jpg' },
  { id: 'coffee-tea', label: 'Coffee & Tea', description: 'Espresso drinks and tea selection.', image: '/image/AVICMEDIA-82.jpg' },
];
...
const DRINKS_CATEGORIES: MenuCategory[] = [
  ...
  { id: 'mocktails', label: 'Mocktails', description: 'Non-alcoholic cocktails — $13.', image: '/image/AVICMEDIA-82.jpg' },
  { id: 'tequila-pops', label: 'Tequila Pops', description: 'Tequila margaritas with fresh fruit popsicles — $17.', image: '/image/AVICMEDIA-82.jpg' },
  { id: 'cantaritos', label: 'Cantaritos', description: 'Mezcal served in traditional clay cups — $18.', image: '/image/AVICMEDIA-82.jpg' },
  { id: 'beer', label: 'Beer', description: 'Imported Mexican and craft beers — $10.', image: '/image/Oh-Mexico-1.jpg' },
  { id: 'mezcal', label: 'Mezcal', description: 'Premium mezcal selection.', image: '/image/AVICMEDIA-82.jpg' },
  { id: 'sodas', label: 'Sodas & Water', description: 'Mexican sodas and waters.', image: '/image/AVICMEDIA-82.jpg' },
  { id: 'tequila-blanco', label: 'Tequila Silver', description: 'Silver and Blanco tequilas.', image: '/image/AVICMEDIA-82.jpg' },
  { id: 'tequila-reposado', label: 'Tequila Reposado', description: 'Aged 2–12 months in oak barrels.', image: '/image/AVICMEDIA-82.jpg' },
