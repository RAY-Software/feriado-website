...
const FOOD_CATEGORIES: MenuCategory[] = [
  ...
  { id: 'seafood', label: 'Seafood Appetizers', description: 'Fresh from the sea.', image: '/image/feriado/aceituna.png' },
  { id: 'tostadas', label: 'Tostadas', description: 'Crispy tostadas — $18 per order.', image: '/image/feriado/aceituna.png' },
  { id: 'tacos', label: 'TACOH!S', description: 'Order of 3 tacos with white rice & refried black beans. Choose: Soft corn, Soft blue corn or Flour tortilla.', image: '/image/feriado/aceituna.png' },
  { id: 'specialties', label: 'Mexican Specialties', description: 'Traditional Mexican entrees.', image: '/image/feriado/aceituna.png' },
...
const DRINKS_CATEGORIES: MenuCategory[] = [
  { id: 'margaritas', label: 'Margaritas', description: 'Classic and fresh fruit margaritas — $19+.', image: '/image/feriado/vaso-vermu.png' },
  { id: 'micheladas', label: 'Micheladas', description: 'Cold beer with freshly squeezed lemon and house mix.', image: '/image/feriado/sifon-vaso.png' },
  ...
  { id: 'beer', label: 'Beer', description: 'Imported Mexican and craft beers — $10.', image: '/image/feriado/sifon-vaso.png' },
...
const SHARED_DRINKS_ESPA_LINCOLN: MenuItem[] = [
  ...
  // Beer
  { categoryId: 'beer', name: 'Dos Equis Lager', description: 'Pale Lager 4.5%', price: '10', image: '/image/feriado/sifon-vaso.png' },
  { categoryId: 'beer', name: 'Dos Equis Ambar', description: 'Pale Lager 4.7%', price: '10', image: '/image/feriado/sifon-vaso.png' },
  { categoryId: 'beer', name: 'Modelo Especial', description: 'Pale lager 4.4%', price: '10', image: '/image/feriado/sifon-vaso.png' },
  { categoryId: 'beer', name: 'Negra Modelo', description: 'Dunkel lager 5.4%', price: '10', image: '/image/feriado/sifon-vaso.png' },
  { categoryId: 'beer', name: 'Tecate', description: 'Golden lager 4.5%', price: '10', image: '/image/feriado/sifon-vaso.png' },
  { categoryId: 'beer', name: 'Tecate Light', description: 'Light lager 3.9%', price: '10', image: '/image/feriado/sifon-vaso.png' },
  { categoryId: 'beer', name: 'Corona', description: 'Pale lager 4.5%', price: '10', image: '/image/feriado/sifon-vaso.png' },
  { categoryId: 'beer', name: 'Corona Light', description: 'Light lager 4.1%', price: '10', image: '/image/feriado/sifon-vaso.png' },
  { categoryId: 'beer', name: 'Victoria', description: 'Amber lager 4.0%', price: '10', image: '/image/feriado/sifon-vaso.png' },
  { categoryId: 'beer', name: 'Pacifico', description: 'Pale lager 4.5%', price: '10', image: '/image/feriado/sifon-vaso.png' },
  { categoryId: 'beer', name: 'Lagunitas IPA', description: 'IPA 6.2%', price: '10', image: '/image/feriado/sifon-vaso.png' },
  { categoryId: 'beer', name: 'Blue Moon', description: 'Wheat-Ale 5.4%', price: '10', image: '/image/feriado/sifon-vaso.png' },
  { categoryId: 'beer', name: 'Heineken', description: 'Pilsner 5.2%', price: '10', image: '/image/feriado/sifon-vaso.png' },
