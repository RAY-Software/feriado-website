(function () {
  ...
  function init() {
    ...
    bubbleImg.src = '/image/icon-footer.png';
    ...
    speechBubble.textContent = "¡Hola! Soy Sara, ¿en qué puedo ayudarte?";
    ...
    header.innerHTML = `
      <div style="display:flex;align-items:center;gap:12px">
        <div style="width:36px;height:36px;background:#B33D26;border-radius:50%;display:flex;align-items:center;justify-content:center;box-shadow:0 2px 8px rgba(179,61,38,0.4)">
          <img src="/image/icon-footer.png" alt="Feriado Cantina" style="width:20px;height:20px;object-fit:contain">
        </div>
        <div>
    ...
    setTimeout(() => {
      addMsg("¡Hola! Soy Sara 👋 ¿En qué puedo ayudarte? Preguntame sobre nuestro menú, ubicación, horarios, reservas o cualquier cosa sobre Feriado Cantina.", 'bot');
    }, 500);
    ...
    formEl.innerHTML = `
      <input
        id="oh-faqinput"
        autocomplete="off"
        placeholder="Preguntame sobre Feriado Cantina..."
    ...
    function addMsg(text, who, isTyping = false) {
      ...
      if (who === 'user') {
        ...
        avatarImg.src = '/image/icon-footer.png';
        avatarImg.alt = 'Sara';
